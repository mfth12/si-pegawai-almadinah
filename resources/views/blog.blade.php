...
@section('container')
    ...
    @foreach ($posts as $post)
        <article class="mb-4 border-bottom pb-3">
            ...
            <p>Created by <a href="/d" class="text-decoration-none">{{ $post->user->name }}</a> in <a href="/kategori/{{ $post->kategori->slug }}" class="text-decoration-none">{{ $post->kategori->nama }}</a></p>
